...
export type ProductSignals = {
  ...
  fetch_product: Signal<{ id: string }>;
  ...
  // WRITE
  update_market_price: Signal<{ productId: string }>;
...
export type ProductMessages = {
  ...
  product_fetched: Message<{ product: Product }>;
  fetch_product_failed: ErrorMessage<{ id: string }>;
  ...
  popular_products_fetched: Message<{ products: Product[] }>;
  ...
  update_market_price_failed: ErrorMessage<{ productId: string }>;
};
